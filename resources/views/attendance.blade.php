    ...
    <div class="container mx-auto my-10">
        ...
        <div class="bg-white p-6 rounded shadow mb-10">
            ...
            <form method="POST" action="{{ route('attendance.store') }}" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                ...
                <button type="submit"
                    class="bg-blue-600 text-white rounded p-2 hover:bg-blue-700 transition">Save</button>
            </form>
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full border border-gray-200">
                    ...
                    <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <td class="py-2 px-3 border-b">
                                    @if ($att->status == 'Present')
                                        <span
                                            class="bg-green-200 text-green-800 px-2 py-1 rounded-full text-sm">Present</span>
                                    @elseif($att->status == 'Absent')
                                        <span
                                            class="bg-red-200 text-red-800 px-2 py-1 rounded-full text-sm">Absent</span>
                                    @elseif($att->status == 'Holiday')
                                        <span
                                            class="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-sm">Holiday</span>
                                    @elseif($att->status == 'Leave')
                                        <span
                                            class="bg-blue-200 text-blue-800 px-2 py-1 rounded-full text-sm">Leave</span>
                                    @endif
                                </td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="py-4 text-center text-gray-500">No attendance records yet.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
